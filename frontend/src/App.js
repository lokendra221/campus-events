...
//           if (selectedEvent && selectedEvent._id === data.eventId) {
...
//           <h1 className="text-3xl font-bold text-indigo-600 mb-6 text-center">Campus Events</h1>
...
//           <div>
//             <h1 className="text-2xl font-bold text-indigo-600">Campus Events</h1>
...
//                       <p className="text-xs text-gray-500">Organized by {event.organizer?.name || 'Unknown'}</p>
//                     </div>
//                   </div>
//                 ))}
//               </div>
...
//                     <p className="text-sm">{new Date(selectedEvent.date).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</p>
//                   </div>
//                 </div>
...
//                     <p className="font-semibold">{selectedEvent.organizer?.name || 'Unknown'}</p>
//                   </div>
//                 </div>
//               </div>
...
//                   selectedEvent.userRegistration.status === 'approved' ? 'bg-green-50 border border-green-200' :
//                   selectedEvent.userRegistration.status === 'rejected' ? 'bg-red-50 border border-red-200' :
//                   'bg-yellow-50 border border-yellow-200'
//                 }`}>
//                   <div className="flex items-center gap-2">
//                     {selectedEvent.userRegistration.status === 'approved' && <CheckCircle className="w-5 h-5 text-green-600" />}
//                     {selectedEvent.userRegistration.status === 'rejected' && <XCircle className="w-5 h-5 text-red-600" />}
//                     {selectedEvent.userRegistration.status === 'pending' && <AlertCircle className="w-5 h-5 text-yellow-600" />}
...
//                 <div className="mt-8">
//                   <h3 className="text-xl font-semibold text-gray-800 mb-4">Manage Registrations</h3>
//                   <div className="space-y-3">
//                     {registrations.map(reg => (
//                       <div key={reg._id} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
//                         <div>
//                           <p className="font-semibold text-gray-800">{reg.user?.name || 'Unknown'}</p>
